...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            var additional = new[] { new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null } };
            return Emps.Select(emp => new { emp.Ename, emp.Job, emp.HireDate }).Union(additional);
        }
        ...
        public static IEnumerable<object> Task11()
        {
            return Emps.GroupBy(emp => emp.Deptno)
                .Where(group => group.Count() > 1 && group.Key != null)
